      ...
      return [
        {
          ...
          items: [
            ...
            },
            {
              id: "staff",
              label: "Staff access",
              href: `/organizer/events/${eventId}#check-in-staff`,
            },
          ],
        },
      ];
          ...
          items: [
            {
              ...
              href: "/super-admin#platform-overview",
            },
            { id: "users", label: "Users", href: "/super-admin#all-users" },
            { id: "organizers", label: "Organizers", href: "/super-admin#organizers" },
            { id: "events", label: "Events", href: "/super-admin#all-events" },
            { id: "audit", label: "Audit log", href: "/super-admin#audit-log" },
            {
              id: "smtp",
